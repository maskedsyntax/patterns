...
class AppTheme {
  static const Color primaryYellow = Color(
    0xFFFFD700,
  ); // Bright Yellow for Dark
  static const Color primaryGold = Color(
    0xFFB8960F,
  ); // Deep Gold for Light (readable on white)
  static const Color primaryAmber = Color(
    0xFFB45309,
  ...
  static ThemeData mobileDarkTheme = ThemeData(
    ...
    fontFamily: sansFamily,
    textTheme: _buildMobileTextTheme(textPrimary, textSecondary),
